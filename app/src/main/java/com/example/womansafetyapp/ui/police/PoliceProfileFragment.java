...
import com.example.womansafetyapp.databinding.FragmentPoliceProfileBinding;
...
public class PoliceProfileFragment extends Fragment {
    ...
    private FragmentPoliceProfileBinding binding;
    private WomanViewModel profileViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = FragmentPoliceProfileBinding.inflate(inflater, container, false);
    ...
    private void handleProfile(Resource<User> resource) {
        if (resource != null && resource.isSuccess() && resource.getData() != null) {
            ...
            binding.textProfileRole.setText(getString(R.string.role_police));
        }
    }
